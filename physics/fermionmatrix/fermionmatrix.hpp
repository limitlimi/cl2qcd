...
protected:
	Fermionmatrix(bool herm, hmc_float _kappa, hmc_float _mubar, const hardware::System& system, hmc_float _csw = 0.) : Fermionmatrix_basic(system, herm, _kappa, _mubar, _csw) { };
...
protected:
	Fermionmatrix_eo(bool herm, hmc_float _kappa, hmc_float _mubar, const hardware::System& system, hmc_float _csw = 0.) : Fermionmatrix_basic(system, herm, _kappa, _mubar, _csw) { };
};
...
public:
    ...
    //overloaded constructor for additional parameter _csw
	Aee(hmc_float _kappa, hmc_float _mubar, const hardware::System& system, hmc_float _csw) : Fermionmatrix_eo(false, _kappa, _mubar, system, _csw), tmp(system), tmp2(system) { };
