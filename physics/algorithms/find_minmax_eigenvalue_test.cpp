...
BOOST_AUTO_TEST_CASE(wilson_eo_max)
{
	using namespace physics::lattices;
	using namespace physics::algorithms;
...
BOOST_AUTO_TEST_CASE(wilson_min)
{
	using namespace physics::lattices;
	using namespace physics::algorithms;
...
BOOST_AUTO_TEST_CASE(wilson_maxmin)
{
	using namespace physics::lattices;
	using namespace physics::algorithms;
...
//	hmc_float ref_max_eig = 3.3878964603747419;
	...
	hmc_float max,min;
	find_maxmin_eigenvalue(max, min, matrix, gf, system, interfacesHandler, 1.e-3, interfacesHandler.getAdditionalParameters<Spinorfield>());
...
BOOST_AUTO_TEST_CASE(wilson_eo_maxmin)
{
	using namespace physics::lattices;
	using namespace physics::algorithms;
...
//	hmc_float ref_max_eig = 3.3878964603747419;
	...
	hmc_float max,min;
	find_maxmin_eigenvalue(max, min, matrix, gf, system, interfacesHandler, 1.e-3, interfacesHandler.getAdditionalParameters<Spinorfield_eo>());
