...
void hardware::code::Molecular_Dynamics::fill_kernels()
{
	...
	if(kernelParameters->getUseEo() == true) {
        ...
        fermion_force_clover1_eo_0 = createKernel("fermion_force_clover1_eo_0") << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl" << "fermionmatrix.cl" << "operations_matrix6x6.cl" << "force_fermion_clover1_eo.cl";
        fermion_force_clover1_eo_1 = createKernel("fermion_force_clover1_eo_1") << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl" << "fermionmatrix.cl" << "operations_matrix6x6.cl" << "force_fermion_clover1_eo.cl";
        fermion_force_clover1_eo_2 = createKernel("fermion_force_clover1_eo_2") << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl" << "fermionmatrix.cl" << "operations_matrix6x6.cl" << "force_fermion_clover1_eo.cl";
        fermion_force_clover1_eo_3 = createKernel("fermion_force_clover1_eo_3") << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl" << "fermionmatrix.cl" << "operations_matrix6x6.cl" << "force_fermion_clover1_eo.cl";
        fermion_force_clover2_eo_0 = createKernel("fermion_force_clover2_eo_0") << basic_molecular_dynamics_code << "operations_spinorfield_eo.cl" << "fermionmatrix.cl" << "operations_matrix6x6.cl" << "force_fermion_clover2_eo.cl";
